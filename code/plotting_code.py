...
def draw_grouped_barplot(data_df, x_label: str, y_label: str, seaborn_hue: str, bargraph_savepath: str, 
    ...
    ax.set_xlabel('')
    ax.set_ylabel('#tokens', labelpad=30)
    ...
    plt.tight_layout()
    plt.savefig(bargraph_savepath+".png", dpi=100)
